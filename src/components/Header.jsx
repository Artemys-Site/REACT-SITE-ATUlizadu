...
const Header = ({ isLoggedIn: propIsLoggedIn }) => {
  ...
  const rotasClinica = ['/painel-clinica', '/agendamentos', '/relatorios'];
  ...
  const rotasLogadas = ['/home-logado', '/painel-clinica', '/agendamentos', '/relatorios', '/perfil', '/servicos-plus'];
      ...
      <nav className="navbar">
        <div className="nav-logo">
          <Link to={shouldShowLoggedInHeader && isClinica ? '/painel-clinica' : shouldShowLoggedInHeader ? '/home-logado' : '/'}>
            <img src="/Vetorizado.svg" alt="Logo Artemys" />
          </Link>
        ...
        {!shouldShowLoggedInHeader ? (
          ...
          <div className="nav-user-actions">
            <div className="action-icon">
              <img src="/iconeNotificacao.png" alt="Notificações" />
            </div>
            <div className="profile-container">
              <img
                ref={profilePicRef}
                src="/perfilLogado.png"
                alt="Perfil"
