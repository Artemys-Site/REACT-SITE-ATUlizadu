    ...
    <>
        ...
        <div className="home-container">
          <div className="home-content">
            <div className="home-tag">
              <img src="/iconePatapreta.png" alt="ícone de pata" />
              <span>Primeiros Socorros e Bem-Estar Pet</span>
            </div>

            <div className="home-brand">
              <img className="imagem-logo" src="/Vetorizado.svg" alt="Logo Artemys" />
            ...
            <div className="home-botoes">
              <Link to="/planos" className="btn btn-laranja">
                <img src="/iconePlanosplataforma.png" alt="ícone planos" />
                <span>Veja nossos Planos</span>
              </Link>
              <Link to="/ambulancia" className="btn btn-roxo">
                <img src="/iconeChamarambulancia.png" alt="ícone ambulância" />
          ...
          <div className="home-image-wrapper">
            <img className="home-image" src="/ImagemMain1.png" alt="Homem dando carinho para um cachorro" />
          </div>
        </div>
      </section>
      ...
      <section className="secao-servicos">
        <div className="servicos-container">
          <img className="servicos-bg-image" src="/imagemArty.png" alt="Mascote Arty cuidando de um filhote" />
          <div className="servicos-conteudo-overlay">
            <h2>NOSSOS SERVIÇOS</h2>
            <ul className="servicos-lista">
              <li>
                <img src="/Book.png" alt="ícone de um livro" />
                <p>GUIAS E ARTIGOS PARA A SAÚDE E BEM-ESTAR DO SEU PET</p>
              </li>
              <li>
                <img src="/Siren.png" alt="ícone de sirene" />
                <p>SERVIÇOS DE AMBULÂNCIA EM CASOS DE EMERGÊNCIA</p>
              </li>
              <li>
                <img src="/Nurse.png" alt="ícone de saúde" />
          ...
          <div className="card-plano card-plano--orange">
            ...
            <div className="card-plano-body">
              <ul className="lista-beneficios">
                <li>
                  <img className="simbolosBeneficios" src="/check.png" alt="check" />
                ...
                <li className="beneficio-inativo">
                  <img className="simbolosBeneficios" src="/X.png" alt="X" />
        ...
        <div className="cardArtigos">
          <div className="card-artigo">
            <div className="card-artigo-imagem-wrapper">
              <img src="/rotinaImagem.jpeg" alt="Rotina de cuidado com pet" />
            </div>
            <div className="card-artigo-conteudo">
              <div className="card-artigo-categoria">
                <img className="iconeGeneroGuias" src="/iconeEtiquetafav.png" alt="ícone de dicas" />
          ...
          <div className="card-artigo">
            <div className="card-artigo-imagem-wrapper">
              <img src="/imagemGuia2.png" alt="Ilustração de um cachorro com engasgo" />
            </div>
            <div className="card-artigo-conteudo">
              <div className="card-artigo-categoria">
                <img className="iconeGeneroGuias" src="/iconePrimeirosSocorros.png" alt="ícone de primeiros socorros" />
          ...
          <div className="card-artigo">
            <div className="card-artigo-imagem-wrapper">
              <img src="/imagemFebre.jpg" alt="Cachorro doente com bolsa de gelo na cabeça" />
            </div>
            <div className="card-artigo-conteudo">
              <div className="card-artigo-categoria">
                <img className="iconeGeneroGuias" src="/iconeCoracao.png" alt="ícone de primeiros socorros" />
                <p className="nomeGeneroGuia">Primeiros Socorros</p>
              </div>
      ...
      <section className="parcerias">
        ...
        <div className="parceria-container">
          <div className="parceria-imagem">
            <img className="imagemParce" src="/imagemParceria.png" alt="Mascote Artemys e mascote Auma Gêmea" />
          </div>
          <div className="parceria-conteudo">
            <img className="parceria-logo-nome" src="/nomeAumaGemea.png" alt="Nome Do projeto AumaGêmea" />
            ...
            <div className="parceria-beneficios-header">
              <img className="iconeBeneficios" src="/iconeBeneficios.png" alt="icone de uma medalha" />
              <p className="tituloBeneficios">Benefícios</p>
            </div>

            <ul className="parceria-beneficios-lista">
              <li>
                <img src="/pataRoxa.png" alt="icone de uma pata roxa" />
