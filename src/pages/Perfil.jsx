      ...
      <div className="configuracoes-container">
        ...
        <div className="configuracoes-tabs">
          <button
            ...
            data-tab="perfil"
          >
            <img src="/iconePerfilAvalia.png" alt="Perfil" />
            <span>PERFIL</span>
          </button>
          <button
            ...
            data-tab="historico"
          >
            <img src="/iconeCalendarioPreto.png" alt="Histórico" />
            <span>HISTÓRICO</span>
          </button>
          <button
            ...
            <div className="perfil-card">
              <div className="perfil-card-header">
                <div className="perfil-info">
                  <img src="/perfilLogado.png" alt="João Victor" className="perfil-foto" />
                  <div>
                ...
                <button className="btn-editar-perfil">
                  <img src="/iconeConfirmar.png" alt="Editar" />
