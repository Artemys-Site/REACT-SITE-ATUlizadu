        ...
        <div className="rastreamento-banner-content">
          <div className="status-wrapper">
            <div className="status-tag">
              <img src="/check.png" alt="Check" className="check-icon" />
            ...
            <div className="rastreamento-left-column">
              <div className="mapa-section">
                ...
                <div className="mapa-wrapper">
                  <img src="/imagemMaps.jpeg" alt="Mapa" className="mapa-rastreamento" />
                  <div className="mapa-overlay">
                    <div className="rota-info-box">
                      <div className="rota-item">
                        <img src="/iconeRelogio.png" alt="Carro" className="rota-icon" />
                        <div>
                      ...
                      <div className="rota-item">
                        <img src="/iconeRelogio.png" alt="Bicicleta" className="rota-icon" />
                        <div>
              ...
              <div className="destino-card">
                <div className="destino-header">
                  <img src="/iconLocation.png" alt="Localização" className="destino-icon" />
                ...
                <button className="btn-abrir-maps" onClick={handleAbrirMaps}>
                  <img src="/iconeChamarambulancia.png" alt="Maps" className="maps-icon" />
                  Abrir no Maps
                </button>
              </div>
                ...
                <div className="timeline">
                  ...
                  <div className="timeline-item active">
                    <div className="timeline-icon purple">
                      <img src="/iconeRelogio.png" alt="Relógio" />
                    </div>
                    <div className="timeline-content">
                  ...
                  <div className="timeline-item">
                    <div className="timeline-icon grey">
                      <img src="/iconLocation.png" alt="Localização" />
                    </div>
                    <div className="timeline-content">
            ...
            <div className="rastreamento-right-column">
              <div className="ambulancia-info-card">
                <div className="ambulancia-header-card">
                  <img src="/iconeChamarambulancia.png" alt="Ambulância" className="ambulancia-icon-card" />
                  <div>
              ...
              <div className="motorista-card purple">
                <div className="pessoa-header">
                  <div className="pessoa-avatar-wrapper">
                    <img src="/iconePerfilPreto.png" alt="Ícone" className="pessoa-icon" />
                    <img src="/drCarlos.png" alt="Carlos Silva" className="pessoa-foto" />
                  </div>
                  <div className="pessoa-info">
                    <h3 className="pessoa-nome">CARLOS SILVA</h3>
                    <div className="pessoa-avaliacao">
                      <img src="/iconAvaliacao.png" alt="Estrela" className="estrela-icon" />
                ...
                <div className="pessoa-botoes">
                  <button className="btn-pessoa" onClick={() => handleLigar('11914886511')}>
                    <img src="/iconTelefone.png" alt="Telefone" />
                    Ligar
                  </button>
                  <button className="btn-pessoa" onClick={() => handleChat('Carlos Silva')}>
                    <img src="/iconeEmail.png" alt="Chat" />
                    Chat
                  </button>
                </div>
              </div>
              ...
              <div className="veterinario-card orange">
                <div className="pessoa-header">
                  <div className="pessoa-avatar-wrapper">
                    <img src="/iconePerfilPreto.png" alt="Ícone" className="pessoa-icon" />
                    <img src="/drAnaPaula.png" alt="Ana Paula Ribeiro" className="pessoa-foto" />
                  </div>
                  <div className="pessoa-info">
              ...
              <div className="importante-card blue">
                <div className="importante-header">
                  <img src="/iconeAlerta.png" alt="Alerta" className="alerta-icon" />
              ...
              <button className="btn-emergencia" onClick={() => handleLigar('11914886511')}>
                <img src="/iconTelefone.png" alt="Telefone" className="emergencia-icon" />
