        ...
        <div className="busca-servicos-container">
          ...
          <form className="busca-input-group" onSubmit={handleBuscar}>
            <div className="input-wrapper">
              <img src="/iconSearch.png" alt="Ícone de lupa" className="input-icon" />
              <input 
                type="text" 
                id="busca-texto" 
            ...
            <div className="input-wrapper">
              <img src="/iconLocation.png" alt="Ícone de localização" className="input-icon" />
              <input 
                type="text" 
                id="busca-local" 
          ...
          <div className="estatisticas-servicos">
            ...
            <div className="estatistica-item">
              <span className="estatistica-numero">4.8<img src="/iconAvaliacao.png" alt="Estrela" className="estrela-icone" /></span>
              ...
              <div key={servico.id} className="card-servico" data-tipo={servico.tipo}>
                ...
                <div className="card-servico-info">
                  ...
                  <p className="local-anos">
                    <img src="/iconLocation.png" alt="Localização" /> {servico.localizacao}{' '}
                    <img src="/iconMaleta.png" alt="Maleta" /> {servico.anos}
                  </p>
                  <p className="horario-valor">
                    <img src="/iconCloack.png" alt="Horário" /> {servico.horario}{' '}
                  ...
                  <div className="card-botoes">
                    <button className="btn-contato">
                      <img src="/iconTelefone.png" alt="Telefone" /> Contatar
                    </button>
